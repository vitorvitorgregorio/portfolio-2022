            ...
            <div className="container">
                <article className="services__cards">
                    ...
                    <div className="services__card">
                        ...
                        <p>Desenvolvimento de sites profissionais, portfólios e landing pages.</p>
                    </div>
                    <div className="services__card">
                        ...
                        <p>Desenvolvimento de interfaces responsivas que se adaptam a todos os tipos de telas.</p>
                    </div>
                </article>
                <article className="services__description">
                    ...
                    <p className="paragraph services__paragraph">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam, veritatis quia placeat similique nobis est voluptatem laudantium harum.
                    </p>
                </article>
            </div>
        </section>
